<?php
// $Id: page.tpl.php,v 1.1 2010/09/20 18:59:02 prasadshir Exp $
...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  <div id="page" class="page">
      ...
      <div id="header-group-wrapper" class="header-group-wrapper full-width">
        <div id="header-group" class="header-group row <?php print $grid_width; ?>">
          <div id="header-group-inner" class="header-group-inner inner clearfix">
            <?php /*?><?php print theme('grid_block', theme('links', $secondary_links), 'secondary-menu'); ?>
            <?php print theme('grid_block', $search_box, 'search-box'); ?><?php */?>
    ...
    <?php if ($mission): ?>
          <div id="mission"><div id="inner-mission"><?php print $mission; ?></div></div>
        <?php endif; ?>
        ...
        <div id="main" class="main row <?php print $grid_width; ?>">
          <div id="main-inner" class="main-inner inner clearfix">
            ...
            <div id="main-group" class="main-group row nested <?php print $main_group_width; ?>">
          	...
          	<div id="bottom-menu"><?php print $bottom_menu; ?></div>
        </div><!-- /main -->
      </div><!-- /main-wrapper -->
